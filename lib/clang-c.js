...
var CXTUResourceUsageKind = exports.CXTUResourceUsageKind = Struct({
  CXTUResourceUsage_AST: ref.types.int32,
  CXTUResourceUsage_Identifiers: ref.types.int32,
  CXTUResourceUsage_Selectors: ref.types.int32,
  CXTUResourceUsage_GlobalCompletionResults: ref.types.int32,
  CXTUResourceUsage_SourceManagerContentCache: ref.types.int32,
  CXTUResourceUsage_AST_SideTables: ref.types.int32,
  CXTUResourceUsage_SourceManager_Membuffer_Malloc: ref.types.int32,
  CXTUResourceUsage_SourceManager_Membuffer_MMap: ref.types.int32,
  CXTUResourceUsage_ExternalASTSource_Membuffer_Malloc: ref.types.int32,
  CXTUResourceUsage_ExternalASTSource_Membuffer_MMap: ref.types.int32,
  CXTUResourceUsage_Preprocessor: ref.types.int32,
  CXTUResourceUsage_PreprocessingRecord: ref.types.int32,
  CXTUResourceUsage_SourceManager_DataStructures: ref.types.int32,
  CXTUResourceUsage_Preprocessor_HeaderSearch: ref.types.int32,
  CXTUResourceUsage_MEMORY_IN_BYTES_BEGIN: ref.types.int32,
  CXTUResourceUsage_MEMORY_IN_BYTES_END: ref.types.int32,
  CXTUResourceUsage_First: ref.types.int32,
  CXTUResourceUsage_Last: ref.types.int32,
});
var CXTUResourceUsageKindPtr = exports.CXTUResourceUsageKindPtr = ref.refType(CXTUResourceUsageKind);
...
var CXCursorKind = exports.CXCursorKind = Struct({
  CXCursor_UnexposedDecl: ref.types.int32,
  CXCursor_StructDecl: ref.types.int32,
  CXCursor_UnionDecl: ref.types.int32,
  CXCursor_ClassDecl: ref.types.int32,
  CXCursor_EnumDecl: ref.types.int32,
  CXCursor_FieldDecl: ref.types.int32,
  CXCursor_EnumConstantDecl: ref.types.int32,
  CXCursor_FunctionDecl: ref.types.int32,
  CXCursor_VarDecl: ref.types.int32,
  CXCursor_ParmDecl: ref.types.int32,
  CXCursor_ObjCInterfaceDecl: ref.types.int32,
  CXCursor_ObjCCategoryDecl: ref.types.int32,
  CXCursor_ObjCProtocolDecl: ref.types.int32,
  CXCursor_ObjCPropertyDecl: ref.types.int32,
  CXCursor_ObjCIvarDecl: ref.types.int32,
  CXCursor_ObjCInstanceMethodDecl: ref.types.int32,
  CXCursor_ObjCClassMethodDecl: ref.types.int32,
  CXCursor_ObjCImplementationDecl: ref.types.int32,
  CXCursor_ObjCCategoryImplDecl: ref.types.int32,
  CXCursor_TypedefDecl: ref.types.int32,
  CXCursor_CXXMethod: ref.types.int32,
  CXCursor_Namespace: ref.types.int32,
  CXCursor_LinkageSpec: ref.types.int32,
  CXCursor_Constructor: ref.types.int32,
  CXCursor_Destructor: ref.types.int32,
  CXCursor_ConversionFunction: ref.types.int32,
  CXCursor_TemplateTypeParameter: ref.types.int32,
  CXCursor_NonTypeTemplateParameter: ref.types.int32,
  CXCursor_TemplateTemplateParameter: ref.types.int32,
  CXCursor_FunctionTemplate: ref.types.int32,
  CXCursor_ClassTemplate: ref.types.int32,
  CXCursor_ClassTemplatePartialSpecialization: ref.types.int32,
  CXCursor_NamespaceAlias: ref.types.int32,
  CXCursor_UsingDirective: ref.types.int32,
  CXCursor_UsingDeclaration: ref.types.int32,
  CXCursor_TypeAliasDecl: ref.types.int32,
  CXCursor_ObjCSynthesizeDecl: ref.types.int32,
  CXCursor_ObjCDynamicDecl: ref.types.int32,
  CXCursor_CXXAccessSpecifier: ref.types.int32,
  CXCursor_FirstDecl: ref.types.int32,
  CXCursor_LastDecl: ref.types.int32,
  CXCursor_FirstRef: ref.types.int32,
  CXCursor_ObjCSuperClassRef: ref.types.int32,
  CXCursor_ObjCProtocolRef: ref.types.int32,
  CXCursor_ObjCClassRef: ref.types.int32,
  CXCursor_TypeRef: ref.types.int32,
  CXCursor_CXXBaseSpecifier: ref.types.int32,
  CXCursor_TemplateRef: ref.types.int32,
  CXCursor_NamespaceRef: ref.types.int32,
  CXCursor_MemberRef: ref.types.int32,
  CXCursor_LabelRef: ref.types.int32,
  CXCursor_OverloadedDeclRef: ref.types.int32,
  CXCursor_VariableRef: ref.types.int32,
  CXCursor_LastRef: ref.types.int32,
  CXCursor_FirstInvalid: ref.types.int32,
  CXCursor_InvalidFile: ref.types.int32,
  CXCursor_NoDeclFound: ref.types.int32,
  CXCursor_NotImplemented: ref.types.int32,
  CXCursor_InvalidCode: ref.types.int32,
  CXCursor_LastInvalid: ref.types.int32,
  CXCursor_FirstExpr: ref.types.int32,
  CXCursor_UnexposedExpr: ref.types.int32,
  CXCursor_DeclRefExpr: ref.types.int32,
  CXCursor_MemberRefExpr: ref.types.int32,
  CXCursor_CallExpr: ref.types.int32,
  CXCursor_ObjCMessageExpr: ref.types.int32,
  CXCursor_BlockExpr: ref.types.int32,
  CXCursor_IntegerLiteral: ref.types.int32,
  CXCursor_FloatingLiteral: ref.types.int32,
  CXCursor_ImaginaryLiteral: ref.types.int32,
  CXCursor_StringLiteral: ref.types.int32,
  CXCursor_CharacterLiteral: ref.types.int32,
  CXCursor_ParenExpr: ref.types.int32,
  CXCursor_UnaryOperator: ref.types.int32,
  CXCursor_ArraySubscriptExpr: ref.types.int32,
  CXCursor_BinaryOperator: ref.types.int32,
  CXCursor_CompoundAssignOperator: ref.types.int32,
  CXCursor_ConditionalOperator: ref.types.int32,
  CXCursor_CStyleCastExpr: ref.types.int32,
  CXCursor_CompoundLiteralExpr: ref.types.int32,
  CXCursor_InitListExpr: ref.types.int32,
  CXCursor_AddrLabelExpr: ref.types.int32,
  CXCursor_StmtExpr: ref.types.int32,
  CXCursor_GenericSelectionExpr: ref.types.int32,
  CXCursor_GNUNullExpr: ref.types.int32,
  CXCursor_CXXStaticCastExpr: ref.types.int32,
  CXCursor_CXXDynamicCastExpr: ref.types.int32,
  CXCursor_CXXReinterpretCastExpr: ref.types.int32,
  CXCursor_CXXConstCastExpr: ref.types.int32,
  CXCursor_CXXFunctionalCastExpr: ref.types.int32,
  CXCursor_CXXTypeidExpr: ref.types.int32,
  CXCursor_CXXBoolLiteralExpr: ref.types.int32,
  CXCursor_CXXNullPtrLiteralExpr: ref.types.int32,
  CXCursor_CXXThisExpr: ref.types.int32,
  CXCursor_CXXThrowExpr: ref.types.int32,
  CXCursor_CXXNewExpr: ref.types.int32,
  CXCursor_CXXDeleteExpr: ref.types.int32,
  CXCursor_UnaryExpr: ref.types.int32,
  CXCursor_ObjCStringLiteral: ref.types.int32,
  CXCursor_ObjCEncodeExpr: ref.types.int32,
  CXCursor_ObjCSelectorExpr: ref.types.int32,
  CXCursor_ObjCProtocolExpr: ref.types.int32,
  CXCursor_ObjCBridgedCastExpr: ref.types.int32,
  CXCursor_PackExpansionExpr: ref.types.int32,
  CXCursor_SizeOfPackExpr: ref.types.int32,
  CXCursor_LambdaExpr: ref.types.int32,
  CXCursor_ObjCBoolLiteralExpr: ref.types.int32,
  CXCursor_ObjCSelfExpr: ref.types.int32,
  CXCursor_LastExpr: ref.types.int32,
  CXCursor_FirstStmt: ref.types.int32,
  CXCursor_UnexposedStmt: ref.types.int32,
  CXCursor_LabelStmt: ref.types.int32,
  CXCursor_CompoundStmt: ref.types.int32,
  CXCursor_CaseStmt: ref.types.int32,
  CXCursor_DefaultStmt: ref.types.int32,
  CXCursor_IfStmt: ref.types.int32,
  CXCursor_SwitchStmt: ref.types.int32,
  CXCursor_WhileStmt: ref.types.int32,
  CXCursor_DoStmt: ref.types.int32,
  CXCursor_ForStmt: ref.types.int32,
  CXCursor_GotoStmt: ref.types.int32,
  CXCursor_IndirectGotoStmt: ref.types.int32,
  CXCursor_ContinueStmt: ref.types.int32,
  CXCursor_BreakStmt: ref.types.int32,
  CXCursor_ReturnStmt: ref.types.int32,
  CXCursor_GCCAsmStmt: ref.types.int32,
  CXCursor_AsmStmt: ref.types.int32,
  CXCursor_ObjCAtTryStmt: ref.types.int32,
  CXCursor_ObjCAtCatchStmt: ref.types.int32,
  CXCursor_ObjCAtFinallyStmt: ref.types.int32,
  CXCursor_ObjCAtThrowStmt: ref.types.int32,
  CXCursor_ObjCAtSynchronizedStmt: ref.types.int32,
  CXCursor_ObjCAutoreleasePoolStmt: ref.types.int32,
  CXCursor_ObjCForCollectionStmt: ref.types.int32,
  CXCursor_CXXCatchStmt: ref.types.int32,
  CXCursor_CXXTryStmt: ref.types.int32,
  CXCursor_CXXForRangeStmt: ref.types.int32,
  CXCursor_SEHTryStmt: ref.types.int32,
  CXCursor_SEHExceptStmt: ref.types.int32,
  CXCursor_SEHFinallyStmt: ref.types.int32,
  CXCursor_MSAsmStmt: ref.types.int32,
  CXCursor_NullStmt: ref.types.int32,
  CXCursor_DeclStmt: ref.types.int32,
  CXCursor_OMPParallelDirective: ref.types.int32,
  CXCursor_LastStmt: ref.types.int32,
  CXCursor_TranslationUnit: ref.types.int32,
  CXCursor_FirstAttr: ref.types.int32,
  CXCursor_UnexposedAttr: ref.types.int32,
  CXCursor_IBActionAttr: ref.types.int32,
  CXCursor_IBOutletAttr: ref.types.int32,
  CXCursor_IBOutletCollectionAttr: ref.types.int32,
  CXCursor_CXXFinalAttr: ref.types.int32,
  CXCursor_CXXOverrideAttr: ref.types.int32,
  CXCursor_AnnotateAttr: ref.types.int32,
  CXCursor_AsmLabelAttr: ref.types.int32,
  CXCursor_PackedAttr: ref.types.int32,
  CXCursor_LastAttr: ref.types.int32,
  CXCursor_PreprocessingDirective: ref.types.int32,
  CXCursor_MacroDefinition: ref.types.int32,
  CXCursor_MacroExpansion: ref.types.int32,
  CXCursor_MacroInstantiation: ref.types.int32,
  CXCursor_InclusionDirective: ref.types.int32,
  CXCursor_FirstPreprocessing: ref.types.int32,
  CXCursor_LastPreprocessing: ref.types.int32,
  CXCursor_ModuleImportDecl: ref.types.int32,
  CXCursor_FirstExtraDecl: ref.types.int32,
  CXCursor_LastExtraDecl: ref.types.int32,
});
var CXCursorKindPtr = exports.CXCursorKindPtr = ref.refType(CXCursorKind);
...
var CXTypeKind = exports.CXTypeKind = Struct({
  CXType_Invalid: ref.types.int32,
  CXType_Unexposed: ref.types.int32,
  CXType_Void: ref.types.int32,
  CXType_Bool: ref.types.int32,
  CXType_Char_U: ref.types.int32,
  CXType_UChar: ref.types.int32,
  CXType_Char16: ref.types.int32,
  CXType_Char32: ref.types.int32,
  CXType_UShort: ref.types.int32,
  CXType_UInt: ref.types.int32,
  CXType_ULong: ref.types.int32,
  CXType_ULongLong: ref.types.int32,
  CXType_UInt128: ref.types.int32,
  CXType_Char_S: ref.types.int32,
  CXType_SChar: ref.types.int32,
  CXType_WChar: ref.types.int32,
  CXType_Short: ref.types.int32,
  CXType_Int: ref.types.int32,
  CXType_Long: ref.types.int32,
  CXType_LongLong: ref.types.int32,
  CXType_Int128: ref.types.int32,
  CXType_Float: ref.types.int32,
  CXType_Double: ref.types.int32,
  CXType_LongDouble: ref.types.int32,
  CXType_NullPtr: ref.types.int32,
  CXType_Overload: ref.types.int32,
  CXType_Dependent: ref.types.int32,
  CXType_ObjCId: ref.types.int32,
  CXType_ObjCClass: ref.types.int32,
  CXType_ObjCSel: ref.types.int32,
  CXType_FirstBuiltin: ref.types.int32,
  CXType_LastBuiltin: ref.types.int32,
  CXType_Complex: ref.types.int32,
  CXType_Pointer: ref.types.int32,
  CXType_BlockPointer: ref.types.int32,
  CXType_LValueReference: ref.types.int32,
  CXType_RValueReference: ref.types.int32,
  CXType_Record: ref.types.int32,
  CXType_Enum: ref.types.int32,
  CXType_Typedef: ref.types.int32,
  CXType_ObjCInterface: ref.types.int32,
  CXType_ObjCObjectPointer: ref.types.int32,
  CXType_FunctionNoProto: ref.types.int32,
  CXType_FunctionProto: ref.types.int32,
  CXType_ConstantArray: ref.types.int32,
  CXType_Vector: ref.types.int32,
  CXType_IncompleteArray: ref.types.int32,
  CXType_VariableArray: ref.types.int32,
  CXType_DependentSizedArray: ref.types.int32,
  CXType_MemberPointer: ref.types.int32,
});
var CXTypeKindPtr = exports.CXTypeKindPtr = ref.refType(CXTypeKind);
