...
exports.generate = function (opts) {
  ...
  */
    ...
    if (type.kind === CONSTANTS.CXTypeKind.CXType_Pointer
      ...
      switch (type.kind)
      {
        ...
        case CONSTANTS.CXTypeKind.CXType_Pointer:
          ...
          break;
        case CONSTANTS.CXTypeKind.CXType_ConstantArray:
          ...
          break;
        case CONSTANTS.CXTypeKind.CXType_Void:
          ret = new PODType('ref.types.void');
          break;
        case CONSTANTS.CXTypeKind.CXType_Bool:
          ret = new PODType('ref.types.byte');
          break;
        case CONSTANTS.CXTypeKind.CXType_Char_U:
        case CONSTANTS.CXTypeKind.CXType_UChar:
          ret = new PODType('ref.types.uchar');
          break;
        case CONSTANTS.CXTypeKind.CXType_UShort:
          ret = new PODType('ref.types.ushort');
          break;
        case CONSTANTS.CXTypeKind.CXType_UInt:
          ret = new PODType('ref.types.uint32');
          break;
        case CONSTANTS.CXTypeKind.CXType_ULong:
          ret = new PODType('ref.types.ulong');
          break;
        case CONSTANTS.CXTypeKind.CXType_ULongLong:
          ret = new PODType('ref.types.ulonglong');
          break;
        case CONSTANTS.CXTypeKind.CXType_Char_S:
        case CONSTANTS.CXTypeKind.CXType_SChar:
          ret = new PODType('ref.types.char');
          break;
        case CONSTANTS.CXTypeKind.CXType_Short:
          ret = new PODType('ref.types.short');
          break;
        case CONSTANTS.CXTypeKind.CXType_Int:
          ret = new PODType('ref.types.int32');
          break;
        case CONSTANTS.CXTypeKind.CXType_Long:
          ret = new PODType('ref.types.long');
          break;
        case CONSTANTS.CXTypeKind.CXType_LongLong:
          ret = new PODType('ref.types.longlong');
          break;
        case CONSTANTS.CXTypeKind.CXType_Float:
          ret = new PODType('ref.types.float');
          break;
        case CONSTANTS.CXTypeKind.CXType_Double:
  ...
  return {
    unmapped: unmapped,
    serialized: "var FFI = require('ffi'), ArrayType = require('ref-array'), Struct = require('ref-struct'), ref = require('ref'); var voidPtr = ref.refType(ref.types.void); " + enums_serialized + serializer + serialize_body,
  };
};
