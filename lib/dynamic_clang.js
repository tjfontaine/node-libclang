...
exports.libclang = new FFI.Library('libclang', {
    ...
    clang_createIndex: [voidPtr, [ref.types.int32, ref.types.int32]],
    clang_disposeIndex: [ref.types.void, [voidPtr]],
    clang_CXIndex_setGlobalOptions: [ref.types.void, [voidPtr, ref.types.uint32]],
    clang_CXIndex_getGlobalOptions: [ref.types.uint32, [voidPtr]],
    clang_getFileName: [CXString, [voidPtr]],
    clang_getFileTime: [ref.types.long, [voidPtr]],
    clang_isFileMultipleIncludeGuarded: [ref.types.uint32, [voidPtr, voidPtr]],
    clang_getFile: [voidPtr, [voidPtr, ref.types.CString]],
    clang_getNullLocation: [CXSourceLocation, []],
    clang_equalLocations: [ref.types.uint32, [CXSourceLocation, CXSourceLocation]],
    clang_getLocation: [CXSourceLocation, [voidPtr, voidPtr, ref.types.uint32, ref.types.uint32]],
    clang_getLocationForOffset: [CXSourceLocation, [voidPtr, voidPtr, ref.types.uint32]],
    ...
    clang_getExpansionLocation: [ref.types.void, [CXSourceLocation, voidPtr, voidPtr, voidPtr, voidPtr]],
    clang_getPresumedLocation: [ref.types.void, [CXSourceLocation, CXStringPtr, voidPtr, voidPtr]],
    clang_getInstantiationLocation: [ref.types.void, [CXSourceLocation, voidPtr, voidPtr, voidPtr, voidPtr]],
    clang_getSpellingLocation: [ref.types.void, [CXSourceLocation, voidPtr, voidPtr, voidPtr, voidPtr]],
    clang_getRangeStart: [CXSourceLocation, [CXSourceRange]],
    clang_getRangeEnd: [CXSourceLocation, [CXSourceRange]],
    clang_getNumDiagnosticsInSet: [ref.types.uint32, [voidPtr]],
    clang_getDiagnosticInSet: [voidPtr, [voidPtr, ref.types.uint32]],
    clang_loadDiagnostics: [voidPtr, [ref.types.CString, voidPtr, CXStringPtr]],
    clang_disposeDiagnosticSet: [ref.types.void, [voidPtr]],
    clang_getChildDiagnostics: [voidPtr, [voidPtr]],
    clang_getNumDiagnostics: [ref.types.uint32, [voidPtr]],
    clang_getDiagnostic: [voidPtr, [voidPtr, ref.types.uint32]],
    clang_getDiagnosticSetFromTU: [voidPtr, [voidPtr]],
    clang_disposeDiagnostic: [ref.types.void, [voidPtr]],
    clang_formatDiagnostic: [CXString, [voidPtr, ref.types.uint32]],
    clang_defaultDiagnosticDisplayOptions: [ref.types.uint32, []],
    clang_getDiagnosticSeverity: [ref.types.uint32, [voidPtr]],
    clang_getDiagnosticLocation: [CXSourceLocation, [voidPtr]],
    clang_getDiagnosticSpelling: [CXString, [voidPtr]],
    clang_getDiagnosticOption: [CXString, [voidPtr, CXStringPtr]],
    clang_getDiagnosticCategory: [ref.types.uint32, [voidPtr]],
    clang_getDiagnosticCategoryName: [CXString, [ref.types.uint32]],
    clang_getDiagnosticCategoryText: [CXString, [voidPtr]],
    clang_getDiagnosticNumRanges: [ref.types.uint32, [voidPtr]],
    clang_getDiagnosticRange: [CXSourceRange, [voidPtr, ref.types.uint32]],
    clang_getDiagnosticNumFixIts: [ref.types.uint32, [voidPtr]],
    clang_getDiagnosticFixIt: [CXString, [voidPtr, ref.types.uint32, CXSourceRangePtr]],
    clang_getTranslationUnitSpelling: [CXString, [voidPtr]],
    clang_createTranslationUnitFromSourceFile: [voidPtr, [voidPtr, ref.types.CString, ref.types.int32, voidPtr, ref.types.uint32, voidPtr]],
    clang_createTranslationUnit: [voidPtr, [voidPtr, ref.types.CString]],
    clang_defaultEditingTranslationUnitOptions: [ref.types.uint32, []],
    clang_parseTranslationUnit: [voidPtr, [voidPtr, ref.types.CString, voidPtr, ref.types.int32, voidPtr, ref.types.uint32, ref.types.uint32]],
    clang_defaultSaveOptions: [ref.types.uint32, [voidPtr]],
    clang_saveTranslationUnit: [ref.types.int32, [voidPtr, ref.types.CString, ref.types.uint32]],
    clang_disposeTranslationUnit: [ref.types.void, [voidPtr]],
    clang_defaultReparseOptions: [ref.types.uint32, [voidPtr]],
    clang_reparseTranslationUnit: [ref.types.int32, [voidPtr, ref.types.uint32, voidPtr, ref.types.uint32]],
    clang_getTUResourceUsageName: [ref.types.CString, [ref.types.uint32]],
    clang_getCXTUResourceUsage: [CXTUResourceUsage, [voidPtr]],
    clang_disposeCXTUResourceUsage: [ref.types.void, [CXTUResourceUsage]],
    clang_getNullCursor: [CXCursor, []],
    clang_getTranslationUnitCursor: [CXCursor, [voidPtr]],
    ...
    clang_Cursor_getTranslationUnit: [voidPtr, [CXCursor]],
    clang_createCXCursorSet: [voidPtr, []],
    clang_disposeCXCursorSet: [ref.types.void, [voidPtr]],
    clang_CXCursorSet_contains: [ref.types.uint32, [voidPtr, CXCursor]],
    clang_CXCursorSet_insert: [ref.types.uint32, [voidPtr, CXCursor]],
    ...
    clang_getIncludedFile: [voidPtr, [CXCursor]],
    clang_getCursor: [CXCursor, [voidPtr, CXSourceLocation]],
    ...
    clang_visitChildren: [ref.types.uint32, [CXCursor, voidPtr, ref.types.Object]],
    ...
    clang_getTokenSpelling: [CXString, [voidPtr, CXToken]],
    clang_getTokenLocation: [CXSourceLocation, [voidPtr, CXToken]],
    clang_getTokenExtent: [CXSourceRange, [voidPtr, CXToken]],
    clang_tokenize: [ref.types.void, [voidPtr, CXSourceRange, voidPtr, voidPtr]],
    clang_annotateTokens: [ref.types.void, [voidPtr, CXTokenPtr, ref.types.uint32, CXCursorPtr]],
    clang_disposeTokens: [ref.types.void, [voidPtr, CXTokenPtr, ref.types.uint32]],
    ...
    clang_getCompletionChunkKind: [ref.types.uint32, [voidPtr, ref.types.uint32]],
    clang_getCompletionChunkText: [CXString, [voidPtr, ref.types.uint32]],
    clang_getCompletionChunkCompletionString: [voidPtr, [voidPtr, ref.types.uint32]],
    clang_getNumCompletionChunks: [ref.types.uint32, [voidPtr]],
    clang_getCompletionPriority: [ref.types.uint32, [voidPtr]],
    clang_getCompletionAvailability: [ref.types.uint32, [voidPtr]],
    clang_getCompletionNumAnnotations: [ref.types.uint32, [voidPtr]],
    clang_getCompletionAnnotation: [CXString, [voidPtr, ref.types.uint32]],
    clang_getCompletionParent: [CXString, [voidPtr, voidPtr]],
    clang_getCursorCompletionString: [voidPtr, [CXCursor]],
    clang_defaultCodeCompleteOptions: [ref.types.uint32, []],
    clang_codeCompleteAt: [CXCodeCompleteResultsPtr, [voidPtr, ref.types.CString, ref.types.uint32, ref.types.uint32, voidPtr, ref.types.uint32, ref.types.uint32]],
    ...
    clang_codeCompleteGetDiagnostic: [voidPtr, [CXCodeCompleteResultsPtr, ref.types.uint32]],
    ...
    clang_getInclusions: [ref.types.void, [voidPtr, voidPtr, voidPtr]],
    clang_getRemappings: [voidPtr, [ref.types.CString]],
    clang_getRemappingsFromFileList: [voidPtr, [voidPtr, ref.types.uint32]],
    clang_remap_getNumFiles: [ref.types.uint32, [voidPtr]],
    clang_remap_getFilenames: [ref.types.void, [voidPtr, ref.types.uint32, CXStringPtr, CXStringPtr]],
    clang_remap_dispose: [ref.types.void, [voidPtr]],
    clang_findReferencesInFile: [ref.types.void, [CXCursor, voidPtr, CXCursorAndRangeVisitor]],
    ...
    clang_index_getClientContainer: [voidPtr, [CXIdxContainerInfoPtr]],
    clang_index_setClientContainer: [ref.types.void, [CXIdxContainerInfoPtr, voidPtr]],
    clang_index_getClientEntity: [voidPtr, [CXIdxEntityInfoPtr]],
    clang_index_setClientEntity: [ref.types.void, [CXIdxEntityInfoPtr, voidPtr]],
    clang_IndexAction_create: [voidPtr, [voidPtr]],
    clang_IndexAction_dispose: [ref.types.void, [voidPtr]],
    clang_indexSourceFile: [ref.types.int32, [voidPtr, voidPtr, IndexerCallbacksPtr, ref.types.uint32, ref.types.uint32, ref.types.CString, voidPtr, ref.types.int32, voidPtr, ref.types.uint32, voidPtr, ref.types.uint32]],
    clang_indexTranslationUnit: [ref.types.int32, [voidPtr, voidPtr, IndexerCallbacksPtr, ref.types.uint32, ref.types.uint32, voidPtr]],
    clang_indexLoc_getFileLocation: [ref.types.void, [CXIdxLoc, voidPtr, voidPtr, voidPtr, voidPtr, voidPtr]],
